...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex  items-center justify-center font-sans ">
      ...
      <div  className='sm:h-full md:h-[80vh] w-full md:m-10  mt-20   md:border md: rounded-2xl  flex flex-col md:flex-row bg-gray-50  md:overflow-hidden'>

        {/* Left side - Image and intro text */}
        <div className="md:w-5/12  bg-indigo-900 bg-gradient-to-br from-indigo-800 to-indigo-900 text-white flex flex-col justify-center p-8 md:pt-10 md:rounded-l-2xl">
        ...
        <div className="md:w-7/12   overflow-y-auto sm:px-5 md:px-0 ">
