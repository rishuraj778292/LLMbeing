...
//       const response = await axios.post("/api/v1/user/register", filteredData)
...
//       {isSuccessfull && (
//         <div className='absolute inset-0 min-h-screen  min-w-screen flex justify-center items-center  bg-black/50 backdrop-blur-sm'>
//           <motion.div
//             className='p-10 bg-white border rounded-lg shadow-lg flex flex-col gap-6 items-center text-center'
//             initial={{ opacity: 0, scale: 0.8 }}
//             animate={{ opacity: 1, scale: 1 }}
//             transition={{ duration: 0.3, ease: "easeOut" }}
//           >
//             <img
//               src={assets.success_icon} // Replace with your success icon
//               alt="Success"
//               className='h-16 w-16'
//             />
