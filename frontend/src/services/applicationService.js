...
class ApplicationService {
    ...
    async acceptProposal(applicationId, acceptanceData) {
    ...
    async rejectProposal(applicationId, rejectionData) {
    ...
    async getClientApplications(params = {}) {
        const queryString = new URLSearchParams(params).toString();
        const response = await axiosInstance.get(`/api/v1/applications/my-projects?${queryString}`);
        return response.data;
    }
